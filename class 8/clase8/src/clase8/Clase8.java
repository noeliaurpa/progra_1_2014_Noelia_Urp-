        ...
        do {
            ...
            switch (opcion) {
                ...
                case 5:
                    ...
                    int iniciar;
                    int finalizar;
                    Ejercicio1DEL2 sust = new Ejercicio1DEL2();
                    System.out.println("Digie una pequeña oración o una palabra (MAXIMO 30 PALABRAS)");
                    oScanner = new Scanner(System.in);
                    palabr1 = (oScanner.nextLine());
                    System.out.println(" Digite el numero de posicion que quiere ver los caracteres de los datos digitados anteriormente");
                    iniciar = Integer.parseInt(oScanner.nextLine());
                    System.out.println(" Digite el numero de posicion que quiere terminar de ver los caracteres de los datos digitados anteriormente");
                    finalizar = Integer.parseInt(oScanner.nextLine());
                    palabr3 = palabr1.substring(iniciar, finalizar+1);
                    System.out.println("Los caracteres que quisieras ver de: " + palabr1 + " ,son: " + palabr3);
                ...
                case 6:
                    ...
                    oScanner = new Scanner(System.in);
                    palabrab = (oScanner.nextLine());
                    System.out.println(palabrab + " - la palabra anterior en mayúsculas es:  " + palabrab.toUpperCase());
                    break;
                case 7:
